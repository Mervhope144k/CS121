...
bool BinNum::isValidBinary(char input[]) {
    if (std::strlen(input) == static_cast<unsigned long long>(SIZE) && std::strspn(input, "01") == static_cast<unsigned long long>(SIZE)) {
