...
clockType::clockType() //default cosntructor
{
	hr = 0;
	min = 0;
	sec = 0;
...
Enter the hours, minutes, and seconds: 8 54 59

New myClock: 08:54:59
After incrementing myClock by one sencond, myClock: 08:55:00
hours = 8, minutes = 55, seconds = 0

C:\Users\merve\Documents\CS121\ClassAndDataAbstraction\x64\Debug\ClassAndDataAbstraction.exe (process 5188) exited with code 0.
