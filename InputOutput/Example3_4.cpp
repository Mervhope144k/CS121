...
* and out output the volume of a sphere, the distance between two
...
int main()
{
	...
	cout << "Line 31: Enter the radius of the sphere: ";
	cin >> sphereRadius;
	cout << endl;

	sphereVolume = (4 / 3) * PI * pow(sphereRadius, 3);

	cout << "Line 37: The volume of the sphere is: "
		<< sphereVolume << endl << endl;

	cout << "Line 40: Enter the coordinates of two "
	...
	cout << "Line 47: The distance between the points "
		<< "(" << point1X << ", " << point1Y << ") and "
		<< "(" << point2X << ", " << point2Y << ") is: "
		<< distance << endl << endl;
	...
	cout << "Line 54: The number of characters, "
		<< "including blanks, in \n  \"" << str
		<< "\" is: " << str.length() << endl;
