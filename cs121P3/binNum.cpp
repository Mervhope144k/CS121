...
//
// Date Last Revised : 2023 December 
//
///////////////////////////////////////////////////////////////////////////////
...
BinNum::BinNum(){
    for (int i = 0; i < SIZE; ++i)
        the_num[i] = '0'; // Initialize with all zeros
...
BinNum::BinNum( int num ) : BinNum(){
    for (int i = SIZE - 1; i >= 0; --i) {
        the_num[i] = (num % 2) + '0'; // Converting integer to binary
        num /= 2;
    }
}
...
BinNum BinNum::operator+ ( BinNum &b1 )
{
    ...
    int carry = 0;
    for (int i = SIZE - 1; i >= 0; --i) {
        int sum = (the_num[i] - '0') + (b1.the_num[i] - '0') + carry;
        temp.the_num[i] = (sum % 2) + '0';
        carry = sum / 2;
...
void  BinNum::shiftBinNumBy( int shiftNum, BinNum& initBinNum ){
    ...
    for (int i = 0; i < shiftNum; ++i) {
        initBinNum.the_num[i] = '0'; // Filling with zeros for the shifted positions
    }
}
